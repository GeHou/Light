...
class Helper {
	 ...
	 * @return string
	 */
	public static function __($key, $replacements = array(), $language = null)
	{
	 ...
	 * @return array
	 */
	public static function array_strip_slashes($array)
	{
		$result = array();
		...
		foreach($array as $key => $value)
		{
			...
			// public static function to keep stripping the slashes out of the array,
	 ...
	 * @return object
	 */
	public static function eloquent_to_json($models)
	{
	 ...
	 * @return string
	 */
	public static function url($url = '', $https = null)
	{
	 ...
	 * @return bool
	 */
	public static function str_object($value)
	{
	 ...
	 * @return string
	 */
	public static function root_namespace($class, $separator = '\\')
	{
	 ...
	 * @return bool
	 */
	public static function has_php($version)
	{
	 ...
	 * @return string
	 */
	public static function render_each($partial, array $data, $iterator, $empty = 'raw|')
	{
	 ...
	 * @return string
	 */
	public static function get_cli_option($option, $default = null)
	{
